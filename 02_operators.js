//simple calculator program in JavaScript which can perform the addition, substraction, multiplication, division and exponent on given numbers.
...
switch(operator){
    ...
    case '**': let exponent = value1**value2;
    console.log(`The exponent of ${value1} and ${value2} is ${exponent}`); break;
}